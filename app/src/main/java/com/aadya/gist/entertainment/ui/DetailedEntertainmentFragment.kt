...
import com.aadya.aadyanews.databinding.FragmentDetailedEntertainmentBinding
...
class DetailedEntertainmentFragment : Fragment() {

    private lateinit var newsModel: NewsModel
    private lateinit var mCommonUtils: CommonUtils
    private lateinit var mBinding : FragmentDetailedEntertainmentBinding
    ...
    private fun intializeMembers(inflater: LayoutInflater, container: ViewGroup?) {
        ...
        mBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_detailed_entertainment,
            container,
            false
        )
    ...
    companion object {
        ...
        fun newInstance(newsModel: NewsModel) =
            DetailedEntertainmentFragment().apply {
    ...
    private fun setColorOfApp(
        appColor: Int?,
        binding: FragmentDetailedEntertainmentBinding,
