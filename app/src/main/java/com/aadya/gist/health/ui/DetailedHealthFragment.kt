...
import com.aadya.aadyanews.databinding.FragmentDetailedHealthBinding
...
class DetailedHealthFragment : Fragment() {

    private lateinit var newsModel: NewsModel
    private lateinit var mCommonUtils: CommonUtils
    private lateinit var mBinding : FragmentDetailedHealthBinding
    ...
    private fun intializeMembers(inflater: LayoutInflater, container: ViewGroup?) {
        ...
        mBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_detailed_health,
            container,
            false
        )
    ...
    private fun setColorOfApp(
        appColor: Int?,
        binding: FragmentDetailedHealthBinding,
