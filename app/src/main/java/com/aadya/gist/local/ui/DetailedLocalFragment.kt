...
import com.aadya.aadyanews.databinding.FragmentDetailedLocalBinding
...
class DetailedLocalFragment : Fragment() {

    private lateinit var newsModel : NewsModel
    private lateinit var mCommonUtils: CommonUtils
    private lateinit var mBinding : FragmentDetailedLocalBinding
    ...
    private fun intializeMembers(inflater: LayoutInflater, container: ViewGroup?) {
        ...
        mBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_detailed_local,
            container,
            false
        )
    ...
    private fun setColorOfApp(
        appColor: Int?,
        binding: FragmentDetailedLocalBinding,
