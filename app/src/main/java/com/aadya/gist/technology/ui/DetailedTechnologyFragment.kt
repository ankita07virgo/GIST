...
import com.aadya.aadyanews.databinding.FragmentDetailedTechnologyBinding
...
class DetailedTechnologyFragment : Fragment() {

    private lateinit var newsModel: NewsModel
    private lateinit var mCommonUtils: CommonUtils
    private lateinit var mBinding : FragmentDetailedTechnologyBinding
    ...
    private fun intializeMembers(inflater: LayoutInflater, container: ViewGroup?) {
        ...
        mBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_detailed_technology,
            container,
            false
        )
    ...
    companion object {
        ...
        fun newInstance(newsModel: NewsModel) =
            DetailedTechnologyFragment().apply {
    ...
    private fun setColorOfApp(
        appColor: Int?,
        binding: FragmentDetailedTechnologyBinding,
