...
import com.aadya.gist.technology.model.TechnologyNewsModel
import com.aadya.gist.utils.CommonUtils
import com.aadya.gist.utils.Connection
import retrofit2.Response

class TechnologyNewsRepository(application: Application) {
    private var application : Application

    init {
        this.application = application
    }
    private val technologyNewsLiveData = MutableLiveData<List<NewsModel>>()
    ...
    fun getTechnologyNewsListState() : MutableLiveData<List<NewsModel>> {
        return  technologyNewsLiveData
    }
                        ...
                        try {
                            if (model?.statusCode == 200) {
                                if (response.body() != null) {
                                    ...
                                    technologyNewsLiveData.value = model.newsList
